...
stdenv.mkDerivation {
  ...
  postPatch = ''
    ...
    substituteInPlace src/color_dialog/src/main.ts --replace "Gtk?version=3.0" "Gtk"
    substituteInPlace src/floating_exceptions/src/main.ts --replace "Gtk?version=3.0" "Gtk"
  '';
