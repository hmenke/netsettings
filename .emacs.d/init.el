...
(use-package hippie-exp
  :bind ("M-/" . user/complete-hippie-expand)
  :init
  ...
  (defun user/complete-hippie-expand-with (hippie-expand-function)
    "Offer completion using the specified hippie-expand function."
    (let* ((options (user/hippie-expand-completions hippie-expand-function))
           (selection (and options (completing-read "Completions: " options))))
      (if selection (he-substitute-string selection t)
        (message "No expansion found"))))

  (defun user/complete-hippie-expand ()
    "Offer completion for the word at point."
    (interactive)
    (user/complete-hippie-expand-with 'hippie-expand)))
